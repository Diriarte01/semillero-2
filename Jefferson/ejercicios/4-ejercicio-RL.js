...
define(["N/record"], function (record) {
  const handlers = {};
  const response = {code: 500,success: false,error: [],data: [],correct: "transaccion creada con exito ",
    ...
    try {
      // peticion exitosa
        ...
        for (const i in data.line) {
          ...
          obj.setSublistValue({sublistId: "item",fieldId: "item",line: i,value: objLine.itemId});
          obj.setSublistValue({sublistId: "item",fieldId: "quantity",line: i,value: objLine.quantity});
        ...
        for (const i in data.line) {
          let objLine = data.line[i]; 
          obj.setSublistValue({sublistId: "item",fieldId: "item",line: i,value: objLine.itemId,})
          obj.setSublistValue({sublistId: "item",fieldId: "amount",line: i,value: objLine.amount,});
